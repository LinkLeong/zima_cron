...
async function fetchTasks(){
  ...
  await Promise.all(tasks.map(async t=>{const lr=await fetch(`${API_BASE}/api/tasks/${t.id}/logs`);t.logs=await lr.json()}));
  renderTasks()
}
